...
type Cytaty = string[]
// type Cytaty = {who: string, what: string}[]
const poranekKojota: Cytaty = ["Kici, kici, taś, taś", "Do lwa ....?"]
const chlopaki: Cytaty = ["Kici, kici, taś, taś", "Do lwa ....?"]
const davinci: Cytaty = ["Kici, kici, taś, taś", "Do lwa ....?"]
